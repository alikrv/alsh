...
@include @import @define @main @justrunit @justcarryon @stdlib @noffi
!global
...
(All numbers are treated as int in v1)
...
### 12.6.2 Chain isolation

Chains do NOT interact with system pipes unless explicitly invoked:
